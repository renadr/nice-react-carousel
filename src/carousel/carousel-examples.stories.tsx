...
export const CarouselNewsExample = () => (
  <>
  ...
  <Carousel itemsToShow={1} space={0}>
    ...
    <ItemNews style={{backgroundImage: 'url(https://images.pexels.com/photos/355465/pexels-photo-355465.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)'}}>
      <Title>Title 2</Title>
      <Desc>Lorem ipsum</Desc>
    </ItemNews>
    <ItemNews style={{backgroundImage: 'url(https://images.pexels.com/photos/1034662/pexels-photo-1034662.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)'}}>
      <Title>Title 3</Title>
      <Desc>Lorem ipsum</Desc>
    </ItemNews>
    <ItemNews style={{backgroundImage: 'url(https://images.pexels.com/photos/1776924/pexels-photo-1776924.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)'}}>
      <Title>Title 4</Title>
      <Desc>Lorem ipsum</Desc>
    </ItemNews>
  </Carousel>
...
export const CarouselListExample = () => (
  <>
  <StoryBookTitle>Exemple : Carousel for lists</StoryBookTitle>
  <StoryBookDesc>#1 : 'normal' mode, 4 items displayed in the same time and 30px of space between items.</StoryBookDesc>
  ...
  <StoryBookDesc>#2 : 'variableWidth' mode, width of 250px and space of 30px. That can show the next item every time.</StoryBookDesc>
