...
var Carousel = function (props) {
    ...
    var _v = useState(0), slidesListWidth = _v[0], setSlidesListWidth = _v[1];
    var _w = useState({
        breakpoint: 0,
    ...
    var showArrow = function (shouldDisplay, customArrow, onClick, propsArrow) {
        if (actual.arrows && shouldDisplay) {
            customArrow && React.cloneElement(customArrow, __assign({ onClick: onClick }, propsArrow));
            return (React.createElement(CarouselArrow, __assign({ onClick: onClick }, propsArrow),
                React.createElement(Arrow, __assign({}, propsArrow))));
        }
        return null;
    };
    ...
    return (React.createElement(CarouselContainer, null,
        ...
        actual.dots && (React.createElement(DotsList, null, getActivableChildren().map(function (_, id) {
            if (typeof dots === 'function') {
                return React.cloneElement(dots(active === id), { key: id });
            }
            return (React.createElement(Dot, { key: id, active: active === id * actual.itemsToSlide, onClick: function () { return setActive(id); } }));
        })))));
};
